...
### Usage tracking — required on every call
Every AI call must include the authenticated user's email for cost attribution and budget enforcement.
...
- Image generation: `gemini/imagen-4.0-fast-generate-001`

Usage dashboard: https://litellm.amzur.com/ui
